    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-[#070709] text-white overflow-hidden relative font-sans">
      ...
      <div className="hidden md:flex md:w-1/2 flex-col justify-between p-12 bg-gradient-to-b from-[#0a0a0e] to-[#050507] border-r border-white/5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center flex-grow py-12">
          ...
          <div className="text-center mt-6">
            <h3 className="text-2xl font-bold tracking-wide gold-gradient-text uppercase">Join the Showcase</h3>
            <p className="text-slate-400 text-sm max-w-xs mx-auto mt-2">
              Create an account to gain entry and manage your personal luxury garage.
            </p>
          </div>
        </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 relative z-10">
        <div className="w-full max-w-md p-8 md:p-10 glass-panel rounded-3xl animate-fade-in">
          ...
          <h2 className="text-3xl font-extrabold mb-1.5 gold-gradient-text tracking-tight">Create Account</h2>
          <p className="text-slate-400 text-sm mb-6">Create credentials to register as a new client.</p>
          
          {error && (
            <div className="mb-6 p-4 bg-red-955/45 border border-red-500/35 text-red-200 rounded-xl text-xs flex items-center gap-2.5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-xs font-bold uppercase tracking-wider mb-1.5 text-slate-400">
                Full Name
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 bg-[#0a0a0e]/95 border border-white/5 focus:border-[#dfa959] rounded-xl text-white text-sm transition-all focus:outline-none focus:ring-1 focus:ring-[#dfa959]/30"
                  required
                />
              </div>
            </div>
            ...
            <div>
              <label htmlFor="email" className="block text-xs font-bold uppercase tracking-wider mb-1.5 text-slate-400">
                Email Address
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-500">
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-bold uppercase tracking-wider mb-1.5 text-slate-400">
                Password
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-500">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-11 py-2.5 bg-[#0a0a0e]/95 border border-white/5 focus:border-[#dfa959] rounded-xl text-white text-sm transition-all focus:outline-none focus:ring-1 focus:ring-[#dfa959]/30"
                  required
                />
                <button
                  type="button"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs font-bold uppercase tracking-wider mb-1.5 text-slate-400">
                Confirm Password
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-500">
          ...
          <p className="mt-8 text-center text-xs text-slate-400">
            ...
            <a href="/login" className="text-[#dfa959] hover:text-amber-300 font-bold transition-colors underline underline-offset-4">
              Login here
            </a>
          </p>
        </div>

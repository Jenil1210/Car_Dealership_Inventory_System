        ...
        <div className="mt-20 pt-10 border-t border-white/5">
          ...
          {purchasedItems.length === 0 ? (
            <div className="text-center text-slate-550 py-16 bg-[#121216]/10 border border-white/5 border-dashed rounded-3xl">
              ...
              <p className="text-xxs text-slate-550 mt-1">Make your first vehicle purchase above to log records into your secure garage.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div key={item.id} className="bg-[#121216]/65 border border-white/5 p-6 rounded-2xl flex items-center justify-between shadow-lg hover:border-[#dfa959]/20 transition-colors">
                  <div>
                    ...
                    <p className="text-xxs text-slate-500 mt-2 font-bold uppercase tracking-wider">
                      <i className="fa-solid fa-calendar-check mr-1.5 text-slate-650"></i>
